...
Este repositorio contiene una prueba técnica que utiliza .NET para el backend y SQL Server para la base de datos, este proyecto utiliza el patrón CQRS. Sigue los pasos a continuación para desplegar y probar la aplicación.
...
- En la carpeta postman, se encuentra una colección de Postman con todos los endpoints del proyecto. Puedes importarla en tu Postman para usarla.
